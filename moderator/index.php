<?php
	...
	if ( isset($_SESSION['tagger_id'])!="" ) {
		header("tagger_user: tagger_job_list.php");
		exit;
	}
	if ( isset($_SESSION['jc_id'])!="" ) {
		header("jc_user: jc_dashboard.php");
		exit;
	}
...
box-shadow:: 5px 5px 4px #adadad;
 ...
 <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7; IE=EmulateIE9">
	...
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0, user-scalable=no"/>
		<link rel="stylesheet" type="text/css" href="css/indexs.css" media="all" />
...
<body>
  ...
  <li><a href="index.php" title=""><strong>Home</strong></a></li>
	...
	<p style="margin-left:210px; margin-top:5px;"><img src="images/title.png" alt="homepage" width="180" height="70" style="margin-left:0px;"><h> upload tweets, create tweet tagging jobs, get answers</h></p>

<div align="center">

	
	<font size="2" color="black"> 
	<p><br> &nbsp;&nbsp;&nbsp; <h style="font-family:courier new;">Web-Based Platform for Manual Tagging of Tweets for Supervised Machine Learning Applications </h> </p>
	...
	<form>
	<p align="center"> 
	<input class="MyButton" type="button" value="SIGN-UP now and get result!" onclick="window.location.href='jc_register.php'" /></p>
	</form> 
	...
	<form>
	<p align="center"> 
	<input class="MyButton2" type="button" value="SIGN-UP now and earn points!" onclick="window.location.href='tagger_register.php'" /></p>
	</form> 
